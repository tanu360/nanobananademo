        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Nano Banana provides an AI-powered image playground that allows users to generate, edit, and upscale images using advanced AI models.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Images generated using our service are subject to the terms of the underlying AI models. You retain rights to your original prompts and uploaded images. Generated images may be subject to additional terms from the Nano Banana API.
              </p>
            </section>
