<div align="center">
  ...
  <p>
    <strong>A React playground for AI image generation, editing, and upscaling with Nano Banana</strong>
  </p>
...
| ----- | -------- | ---- | ----- |
| `nano-banana` | nano-banana-editor | Generate / Edit | Default model, max 4 images |
